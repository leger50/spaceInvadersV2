...
import fr.unilim.iut.spaceInvadersV2.jeu.Direction;
...
public class CollisionTest {
	...
	public void test_Collision_MissileEtEnvahisseur_MemePosition() {
		Missile missile = new Missile(new Dimension(1, 1), new Position(4, 3), 1, Direction.HAUT_ECRAN);
	...
	public void test_Collision_MissileEtEnvahisseur() {
		Missile missile = new Missile(new Dimension(1, 2), new Position(4, 3), 1, Direction.HAUT_ECRAN);
	...
	public void test_PasDeCollision_EnvahisseurEtMissile() {
		Missile missile = new Missile(new Dimension(1, 2), new Position(4, 4), 1, Direction.HAUT_ECRAN);
		Envahisseur envahisseur = new Envahisseur(new Dimension(4, 4), new Position(4, 2), 1);
	...
	public void test_CollisionNord_MissileEtVaisseau() {
		Missile missile = new Missile(new Dimension(1, 3), new Position(4, 8), 1, Direction.HAUT_ECRAN);
	...
	public void test_PasDeCollisionNord_MissileEtVaisseau() {
		Missile missile = new Missile(new Dimension(1, 3), new Position(4, 7), 1, Direction.HAUT_ECRAN);
		Vaisseau vaisseau = new Vaisseau(new Dimension(3,2), new Position(3, 9), 1);
	...
	public void test_CollisionOuest_MissileEtVaisseau() {
		Missile missile = new Missile(new Dimension(1, 1), new Position(2, 8), 1, Direction.HAUT_ECRAN);
	...
	public void test_CollisionEst_MissileEtVaisseau() {
		Missile missile = new Missile(new Dimension(1, 1), new Position(7, 8), 1, Direction.HAUT_ECRAN);
	...
	public void test_PasCollisionEst_MissileEtVaisseau() {
		Missile missile = new Missile(new Dimension(1, 1), new Position(6, 8), 1, Direction.HAUT_ECRAN);
		Vaisseau vaisseau = new Vaisseau(new Dimension(3,3), new Position(7, 9), 1);
